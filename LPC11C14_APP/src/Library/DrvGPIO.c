...
void GPIOSetDir(uint32 portNum, uint32 bitPosi, uint32 dir)
{
	...
	if (((portNum == JTAG_TDI_PIOPORT) && (bitPosi == JTAG_TDI_PIOBIT)) || ((portNum == JTAG_TMS_PIOPORT) && (bitPosi == JTAG_TMS_PIOBIT)) || ((portNum == JTAG_TDO_PIOPORT) && (bitPosi == JTAG_TDO_PIOBIT)) || ((portNum == JTAG_nTRST_PIOPORT) && (bitPosi == JTAG_nTRST_PIOBIT)))
	{
